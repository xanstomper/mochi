...
var logsCmd = &cobra.Command{
	Use:   "logs",
	Short: "View MOCHI logs",
	Long:  `View the logs generated by MOCHI. This command allows you to see the log output for debugging and monitoring.`,
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		logsFile := filepath.Join(cfg.Config().Options.DataDirectory, "logs", "MOCHI.log")
		_, err = os.Stat(logsFile)
		if os.IsNotExist(err) {
			log.Warn("Looks like you are not in a MOCHI project. No logs found.")
			return nil
		}
