...
MOCHI update-providers

# Update Catwalk providers from a custom URL
MOCHI update-providers https://example.com/providers.json

# Update Catwalk providers from a local file
MOCHI update-providers /path/to/local-providers.json

# Update Catwalk providers from embedded version
MOCHI update-providers embedded

# Update Hyper provider information
MOCHI update-providers --source=hyper

# Update Hyper from a custom URL
MOCHI update-providers --source=hyper https://hyper.example.com
`,
