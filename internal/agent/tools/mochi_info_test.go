...
func TestMOCHIInfo_MinimalConfig(t *testing.T) {
	t.Parallel()

	cfg := config.NewTestStore(&config.Config{
		Providers: csync.NewMap[string, config.ProviderConfig](),
	})
	output := buildMOCHIInfo(cfg, nil, nil, nil, nil)
...
func TestMOCHIInfo_ConfigFiles(t *testing.T) {
	t.Parallel()

	cfg := config.NewTestStore(
		&config.Config{Providers: csync.NewMap[string, config.ProviderConfig]()},
		"/home/user/.config/MOCHI/MOCHI.json",
		"/project/.MOCHI/MOCHI.json",
	)
	output := buildMOCHIInfo(cfg, nil, nil, nil, nil)
	require.Contains(t, output, "[config_files]")
	require.Contains(t, output, "/home/user/.config/MOCHI/MOCHI.json")
	require.Contains(t, output, "/project/.MOCHI/MOCHI.json")
}

func TestMOCHIInfo_Models(t *testing.T) {
	t.Parallel()
...
func TestMOCHIInfo_Providers(t *testing.T) {
	t.Parallel()
...
func TestMOCHIInfo_DisabledProvidersOmitted(t *testing.T) {
	t.Parallel()
...
func TestMOCHIInfo_LSPStates(t *testing.T) {
	t.Parallel()
	...
	output := buildMOCHIInfo(cfg, mgr, nil, nil, nil)
...
func TestMOCHIInfo_MCPStates(t *testing.T) {
	t.Parallel()
...
func TestMOCHIInfo_YoloMode(t *testing.T) {
	t.Parallel()
...
func TestMOCHIInfo_AllowedTools(t *testing.T) {
	t.Parallel()
...
func TestMOCHIInfo_DisabledTools(t *testing.T) {
	t.Parallel()
...
func TestMOCHIInfo_Options(t *testing.T) {
	t.Parallel()

	cfg := config.NewTestStore(&config.Config{
		Providers: csync.NewMap[string, config.ProviderConfig](),
		Options: &config.Options{
			DataDirectory:        "/Users/user/project/.MOCHI",
			Debug:                true,
	...
	require.Contains(t, output, "data_directory = /Users/user/project/.MOCHI")
	require.Contains(t, output, "debug = true")
}

func TestMOCHIInfo_AutoSummarizeInversion(t *testing.T) {
	t.Parallel()
	...
	outputFalse := buildMOCHIInfo(cfgFalse, nil, nil, nil, nil)
	...
	outputTrue := buildMOCHIInfo(cfgTrue, nil, nil, nil, nil)
	require.Contains(t, outputTrue, "auto_summarize = true")
}

func TestMOCHIInfo_NoSecrets(t *testing.T) {
	t.Parallel()
...
func TestMOCHIInfo_DeterministicOrdering(t *testing.T) {
	t.Parallel()
...
func TestMOCHIInfo_EmptySectionsOmitted(t *testing.T) {
	t.Parallel()
...
func TestMOCHIInfo_ConfigStaleness_Clean(t *testing.T) {
	t.Parallel()

	dir := t.TempDir()
	configPath := filepath.Join(dir, "MOCHI.json")
	...
	output := buildMOCHIInfo(store, nil, nil, nil, nil)
...
func TestMOCHIInfo_ConfigStaleness_Dirty(t *testing.T) {
	t.Parallel()
...
func TestMOCHIInfo_ConfigStaleness_MissingPath(t *testing.T) {
	t.Parallel()
...
func TestMOCHIInfo_Skills_NoSkills(t *testing.T) {
	t.Parallel()
...
func TestMOCHIInfo_Skills_MixedLoadedUnloaded(t *testing.T) {
	t.Parallel()

	allSkills := []*skills.Skill{
		{Name: "go-doc", Builtin: false},
		{Name: "bash", Builtin: false},
		{Name: "MOCHI-config", Builtin: true},
	}
	activeSkills := allSkills

	tracker := skills.NewTracker(activeSkills)
	tracker.MarkLoaded("bash")
	tracker.MarkLoaded("MOCHI-config")

	cfg := config.NewTestStore(&config.Config{
		Providers: csync.NewMap[string, config.ProviderConfig](),
	})
	output := buildMOCHIInfo(cfg, nil, allSkills, activeSkills, tracker)
	require.Contains(t, output, "[skills]")
	require.Contains(t, output, "bash = user, loaded")
	require.Contains(t, output, "MOCHI-config = builtin, loaded")
	require.Contains(t, output, "go-doc = user, unloaded")
}

func TestMOCHIInfo_Skills_DisabledSkills(t *testing.T) {
	t.Parallel()
	...
	require.Contains(t, output, "MOCHI-config = builtin, unloaded")
	require.Contains(t, output, "image-convert = user, disabled")
}

func TestMOCHIInfo_Skills_Ordering(t *testing.T) {
	t.Parallel()
...
func TestMOCHIInfo_Skills_BuiltinOrigin(t *testing.T) {
	t.Parallel()
...
func TestMOCHIInfo_Hooks(t *testing.T) {
	t.Parallel()
...
func TestMOCHIInfo_Hooks_NoHooks(t *testing.T) {
	t.Parallel()
