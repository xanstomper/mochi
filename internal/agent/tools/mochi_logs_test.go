...
func createTestLogFile(t *testing.T, entries []map[string]any) string {
	t.Helper()
	tempDir := t.TempDir()
	logFile := filepath.Join(tempDir, "MOCHI.log")
...
func TestNewMOCHILogsTool(t *testing.T) {
	t.Parallel()
	tool := NewMOCHILogsTool("/tmp/test.log")
	require.NotNil(t, tool)
	require.Equal(t, MOCHILogsToolName, tool.Info().Name)
}

func TestMOCHILogs_HappyPath(t *testing.T) {
	t.Parallel()
	...
	result := runMOCHILogs(logFile, MOCHILogsParams{Lines: 3})
...
func TestMOCHILogs_DefaultLines(t *testing.T) {
	t.Parallel()
	...
	result := runMOCHILogs(logFile, MOCHILogsParams{Lines: 0})
...
func TestMOCHILogs_MaxCap(t *testing.T) {
	t.Parallel()
	...
	result := runMOCHILogs(logFile, MOCHILogsParams{Lines: 200})

	lines := strings.Split(result, "\n")
	require.Len(t, lines, 100)
}

func TestMOCHILogs_MissingFile(t *testing.T) {
	t.Parallel()
	result := runMOCHILogs("/nonexistent/path/MOCHI.log", MOCHILogsParams{Lines: 50})
	require.Contains(t, result, "No log file found")
}

func TestMOCHILogs_EmptyFile(t *testing.T) {
	t.Parallel()
	tempDir := t.TempDir()
	logFile := filepath.Join(tempDir, "MOCHI.log")
	...
	result := runMOCHILogs(logFile, MOCHILogsParams{Lines: 50})
	require.Contains(t, result, "Log file is empty")
}

func TestMOCHILogs_MalformedLines(t *testing.T) {
	t.Parallel()
	tempDir := t.TempDir()
	logFile := filepath.Join(tempDir, "MOCHI.log")
	...
	result := runMOCHILogs(logFile, MOCHILogsParams{Lines: 10})
...
func TestMOCHILogs_ExtraFieldsSorted(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
	...
	result := runMOCHILogs(logFile, MOCHILogsParams{Lines: 1})
...
func TestMOCHILogs_NonStringValues(t *testing.T) {
	t.Parallel()
	entry := map[string]any{
...
func TestMOCHILogs_Redaction(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
...
func TestMOCHILogs_ReservedFields(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
		{
			"time":   time.Now().Format(time.RFC3339),
...
func TestMOCHILogs_OversizedLines(t *testing.T) {
	t.Parallel()
	tempDir := t.TempDir()
	logFile := filepath.Join(tempDir, "MOCHI.log")
...
func TestMOCHILogs_PartialTrailingLine(t *testing.T) {
	t.Parallel()
	tempDir := t.TempDir()
	logFile := filepath.Join(tempDir, "MOCHI.log")
...
func TestMOCHILogs_ValueQuoting(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
...
func TestMOCHILogs_ChronologicalOrder(t *testing.T) {
	t.Parallel()
...
func TestMOCHILogs_TimeOnlyFormat(t *testing.T) {
	t.Parallel()
	entry := map[string]any{
...
func TestMOCHILogs_LevelVariations(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
	...
	result := runMOCHILogs(logFile, MOCHILogsParams{Lines: 5})
...
func TestMOCHILogs_SourceVariations(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
