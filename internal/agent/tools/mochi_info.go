...
const MOCHIInfoToolName = "MOCHI_info"

//go:embed MOCHI_info.md
var MOCHIInfoDescription string

type MOCHIInfoParams struct{}

func NewMOCHIInfoTool(
	...
	return fantasy.NewAgentTool(
		MOCHIInfoToolName,
		MOCHIInfoDescription,
		func(ctx context.Context, _ MOCHIInfoParams, _ fantasy.ToolCall) (fantasy.ToolResponse, error) {
			return fantasy.NewTextResponse(buildMOCHIInfo(cfg, lspManager, allSkills, activeSkills, skillTracker)), nil
		},
	)
}

func buildMOCHIInfo(cfg *config.ConfigStore, lspManager *lsp.Manager, allSkills []*skills.Skill, activeSkills []*skills.Skill, skillTracker *skills.Tracker) string {
