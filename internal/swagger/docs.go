...
const docTemplate = `{
    ...
    "info": {
        ...
        "license": {
            "name": "MIT",
            "url": "https://github.com/mochi/mochi/blob/main/LICENSE"
        },
        "version": "{{.Version}}"
    },
    "host": "{{.Host}}",
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/github_com_charmbracelet_MOCHI_internal_proto.Message"
                            }
                        }
                    },
                    "404": {
    ...
    "definitions": {
        ...
        "github_com_charmbracelet_MOCHI_internal_config.Config": {
            "type": "object",
            "properties": {
                "$schema": {
                    "type": "string"
                ...
                "options": {
                    "$ref": "#/definitions/github_com_charmbracelet_MOCHI_internal_config.Options"
                },
                "permissions": {
        ...
        "github_com_charmbracelet_MOCHI_internal_config.Options": {
            "type": "object",
            "properties": {
                "attribution": {
        ...
        "github_com_charmbracelet_MOCHI_internal_proto.Message": {
            "type": "object",
            "properties": {
                "created_at": {
                    "type": "integer"
        ...
        "proto.Workspace": {
            ...
            "properties": {
                "config": {
                    "$ref": "#/definitions/github_com_charmbracelet_MOCHI_internal_config.Config"
                },
                "data_dir": {
                    "type": "string"
                },
