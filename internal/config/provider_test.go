...
func TestProviders_Integration_WithMockClients(t *testing.T) {
	...
	catwalkPath := tmpDir + "/MOCHI/providers.json"
	hyperPath := tmpDir + "/MOCHI/hyper.json"
...
func TestProviders_Integration_WithCachedData(t *testing.T) {
	...
	require.NoError(t, os.MkdirAll(tmpDir+"/MOCHI", 0o755))
...
func TestCachePathFor(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			expected:    "/custom/data/MOCHI/providers.json",
		},
		{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if tt.expected != "" {
				...
				require.Contains(t, result, "MOCHI")
