...
glm_5_2_design_examples: List[Dict[str, Any]] = [
    ...
    {"instruction": "Recommendation system", "response": "Collaborative+content+NN", "difficulty": 0.8},
    ...
    {"instruction": "Notification service", "response": "Template+queue+push", "difficulty": 0.6},
    {"instruction": "Distributed crawler", "response": "Frontier+robots+bloom+HDFS", "difficulty": 0.6},
    {"instruction": "Real-time analytics", "response": "Kafka+Flink+ClickHouse+WS", "difficulty": 0.2},
    ...
    {"instruction": "Video streaming", "response": "Transcode+HLS+CDN+ABR", "difficulty": 0.3},
    {"instruction": "Search engine", "response": "Crawler+index+BM25", "difficulty": 0.6},
    {"instruction": "Social feed", "response": "Fanout+Redis+ML rank", "difficulty": 0.2},
