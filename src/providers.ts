...
export const PROVIDERS: Provider[] = [
  ...
  { id: 'freeinference', name: 'freeinference.org (Harvard SEAS)', kind: 'openai', baseUrl: 'https://freeinference.org/v1', envKey: 'FREEINFERENCE_API_KEY', models: ['deepseek-v4-flash', 'glm-5.2', 'glm-5.1', 'minimax-m3', 'minimax-m2.5', 'kimi-k2.7-code', 'qwen3.6-35b', 'diffusiongemma', 'glm-5.3'], defaultModel: 'deepseek-v4-flash' },
  { id: 'openai', name: 'OpenAI', kind: 'openai', baseUrl: 'https://api.openai.com/v1', envKey: 'OPENAI_API_KEY', models: ['gpt-4o', 'gpt-4o-mini', 'gpt-5', 'gpt-5-nano', 'o3', 'o4-mini', 'o1', 'o3-mini'], defaultModel: 'gpt-4o' },
  { id: 'anthropic', name: 'Anthropic', kind: 'anthropic', baseUrl: 'https://api.anthropic.com', envKey: 'ANTHROPIC_API_KEY', models: ['claude-3-7-sonnet-20250219', 'claude-3-5-sonnet-20241022', 'claude-3-5-haiku-20241022', 'claude-opus-4-20250514'], defaultModel: 'claude-3-7-sonnet-20250219' },
  { id: 'gemini', name: 'Google Gemini', kind: 'gemini', baseUrl: 'https://generativelanguage.googleapis.com', envKey: 'GEMINI_API_KEY', models: ['gemini-2.0-flash', 'gemini-2.5-pro', 'gemini-2.0-flash-thinking-exp', 'gemini-2.0-flash-lite'], defaultModel: 'gemini-2.0-flash' },
  ...
  { id: 'openrouter', name: 'OpenRouter', kind: 'openai', baseUrl: 'https://openrouter.ai/api/v1', envKey: 'OPENROUTER_API_KEY', models: ['anthropic/claude-3.7-sonnet', 'anthropic/claude-3.5-sonnet', 'openai/gpt-4o', 'google/gemini-2.0-flash-001', 'deepseek/deepseek-r1'], defaultModel: 'anthropic/claude-3.7-sonnet' },
